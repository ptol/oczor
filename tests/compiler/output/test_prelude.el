...
(puthash 'test_prelude (oc-hash-from-alist (list
  'item1 (funcall (gethash 'check-eq (gethash 'testing oc)) (gethash 'bool (gethash '_eq (gethash 'instances oc))) (not nil) t)
  'item2 (funcall (gethash 'check-eq (gethash 'testing oc)) (gethash 'bool (gethash '_eq (gethash 'instances oc))) (and t nil) nil)
  'item3 (funcall (gethash 'check-eq (gethash 'testing oc)) (gethash 'bool (gethash '_eq (gethash 'instances oc))) (or t nil) t)
  'item4 (funcall (gethash 'check-eq (gethash 'testing oc)) (gethash 'string (gethash '_eq (gethash 'instances oc))) (funcall (gethash 'int (gethash 'show (gethash 'instances oc))) 1) "1")
  'item5 (funcall (gethash 'check-eq (gethash 'testing oc)) (gethash 'string (gethash '_eq (gethash 'instances oc))) (funcall (gethash 'string (gethash 'append (gethash 'instances oc))) "123" "456") "123456"))) oc)
