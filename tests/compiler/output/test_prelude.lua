...
oc.test_prelude = {
  item1 = oc.testing.checkEq(oc.instances.eq.Bool, (not false), true),
  item2 = oc.testing.checkEq(oc.instances.eq.Bool, (true and false), false),
  item3 = oc.testing.checkEq(oc.instances.eq.Bool, (true or false), true),
